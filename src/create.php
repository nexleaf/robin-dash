...
<DownloadLimit>22</DownloadLimit>
<UploadLimit>11</UploadLimit>
...
else if(isset($_GET['type']) && $_GET['type'] == "master") {
?>
<!DOCTYPE HTML>
	...
	<h1><?php echo $brand; ?></h1>
		...
		<div id="page-content">
			<form action="<?php echo $wdir; ?>create.php" method="post" class="register-form">
				...
				<p>To add accounts to your Master Account:<br /><br />Simply change their Notification Email to the one specified here.</p>

				<?php if(isset($show_recaptcha_error)) {echo "<p><i>The reCAPTCHA wasn't entered correctly.<br />Go back and try it again.</i></p>";} ?>
				...
				<?php if($connectivity == "internet") {echo "<div id=\"recaptcha\">" . recaptcha_get_html($recaptcha_publickey, $error = null, $use_ssl = true) . "</div>";} ?>
				
				<br />
				
				<input type="submit" name="submit" value="Create Master Account" style="width:60%;" />&nbsp;<input type="button" value="Cancel" style="width:20%;" onclick="window.location = '<?php echo $wdir; ?>';" />
				</form>
	...
	<h1><?php echo $brand; ?></h1>
		...
		<div id="page-content">
			<form action="<?php echo $wdir; ?>create.php" method="post" class="register-form">
				...
				<p>To create your account, complete the form below. Alternatively, you can import settings from CloudTrax, <a href="import.php" id="a">Click here</a> to do so.<br /><br />To create a Master User, <a href="create.php?type=master">Click Here</a>.</p>
