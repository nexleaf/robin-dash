...
if($_POST['radiorate'] == "on") {$radiorate = "fixed";}
else {$radiorate = "auto";}
...
?>
		...
		<td id=\"data\"><textarea name=\"networknotes\">"; if(file_exists($dir . "data/" . $networkname . "_notes.txt")) {echo file_get_contents($dir . "data/" . $networkname . "_notes.txt");} echo "</textarea></td>
		<td id=\"desc\">&nbsp;</td>
		</tr>
		...
		<tr>
		<td id=\"name\">Transparent Bridging</td>
		<td id=\"data\"><input type=\"checkbox\" name=\"transparentbridge\""; if($xmlp->management->enable_transparent_bridge == "1") {echo " checked";} echo "></td>
		<td id=\"desc\">Bridges the Public wireless network with the LAN.</td>
		</tr>
		...
		<td id=\"desc\">Download Speed limit in Megabits/sec</td>
		</tr>

		<tr>
		<td id=\"name\">Upload Speed</td>
		<td id=\"data\"><input type=\"text\" name=\"upspeed\" value=\"" . $xmlp->nodog->UploadLimit . "\"></td>
		<td id=\"desc\">Upload Speed limit in Megabits/sec</td>
		</tr>
		...
		*/
		...
		<tr>
		<td id=\"name\">Transparent Bridging</td>
		<td id=\"data\"><input type=\"checkbox\" name=\"privatebridge\""; if($xmlp->iprules->filter_AP1_bridge == "1") {echo " checked";} echo "></td>
		<td id=\"desc\">Bridges the Private wireless network with the LAN.</td>
		</tr>
		...
		<td id=\"data\" style=\"text-align:center;\">"; if(file_exists($dir . "data/uploads/" . $networkname . "/ssh.key")) {echo "<a href=\"" . $wdir . "edit.php?page=security&action=delete-sshkey\">Delete SSH Key</a>";} else {echo "<input type=\"file\" name=\"keybasedssh\">";} echo "</td>
		...
		if($xmlp->madwifi->priv_rate == "fixed") {echo " checked";}
