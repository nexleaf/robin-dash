...
<div id="wrapper">
	...
	<div id="content">
		...
		<select name=\"services_upgd_srv\">
			...
			<option value=\"svn6.assembla.com/svn/RobinMesh/downloads/firmware/development/\""; if($xmlp->general->services_upgd_srv == "svn6.assembla.com/svn/RobinMesh/downloads/firmware/development/") {echo " selected";} echo ">Robin-Mesh: Development (Possibly unstable)</option>
		</select>
		</td>
