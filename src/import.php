...
if(isset($_POST['network'])) {
	...
	// strip out all the excess information
...
<div id="login-panel">
	...
	<div id="page-content">
			<form action="<?php echo $wdir; ?>import.php" method="post" class="register-form">
				...
				<p><?php if(!isset($status)) {echo "Simply enter the network name you use to login to the server at CloudTrax.com to import your nodes to " . $brand . ".";} else {echo $status;} ?></p>
