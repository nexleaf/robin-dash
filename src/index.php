...
<body>
<div id="login-panel">	
	<div id="page-content" style="margin-top:30%;">
		<p style="margin-top:-17%;margin-left:-4%;margin-bottom:15%;text-align:center;width:65px;height:12px;color:#fff;background:#222;font-size:14px;border:none;padding:8px 14px;-moz-border-radius:5px;-webkit-border-radius:5px;"><?php echo $_LANG['home']; ?></p>
		<p style="margin-top:-24%;margin-left:34%;margin-bottom:15%;text-align:center;width:65px;height:12px;color:#fff;background:#222;font-size:14px;border:none;padding:8px 14px;-moz-border-radius:5px;-webkit-border-radius:5px;"><a href="#support" style="color:white;" onclick="Modalbox.show('modal-page.php?page=support', {width: 460, title: 'Support'}); return false;"><?php echo $_LANG['support']; ?></a></p>
		<p style="margin-top:-24%;margin-left:72%;margin-bottom:15%;text-align:center;width:65px;height:12px;color:#fff;background:#222;font-size:14px;border:none;padding:8px 14px;-moz-border-radius:5px;-webkit-border-radius:5px;"><a href="#about" style="color:white;" onclick="Modalbox.show('modal-page.php?page=about', {width: 460, title: 'About Us'}); return false;"><?php echo $_LANG['about']; ?></a></p>
		
		<p style="text-align:center;font-size:400%;font-weight:bold;margin-top:-14%;margin-bottom:4%;"><? echo $brand; ?></p>
